...
import { GetCategoriesDto } from '@/modules/ecommerce/user/product-category/dtos/get-categories.dto';
...
@Injectable()
export class UserProductCategoryService extends ListService<ProductCategory> {
  constructor(
